...
class RequestHandler(object):
    ...
    def _stack_context_handle_exception(self, type, value, traceback11):
        try:
            ...
            # sys.exc_info()
            f = open("/home/guangtong/pgt_test/aaa.txt", "a")
            tbf = traceback11.tb_frame
            while tbf:
                f.write("gggggg11"+str(tbf.f_code)+"\n")
                tbf = tbf.f_back
            f.write("gggggg22"+str(type)+"\n")
            f.write("gggggg22"+str(value)+"\n")
            f.close()
            #f = open("/home/guangtong/pgt_test/aaa.txt", "a")
            #tb = traceback11
            #while tb:
            #    f.write("GGGGGG11"+str(tb.tb_lineno)+"\n")
            #    f.write("GGGGGG00"+str(tb.tb_frame.f_code)+"\n")
            #    tbf = tb.tb_next
            #f.close()
            #f.write("gggggggg"+str(type(traceback11))+"\n")
            #f.write("gggggggg"+str(dir(traceback11))+"\n")
            #f.write("gggggggg"+str(dir(traceback11.tb_frame))+"\n")
            #f.write("gggggggg"+str(traceback11.tb_frame.f_lineno)+"\n")
            #f.write("gggggggg"+str(traceback11.tb_frame.f_code)+"\n")
            #f.close()
            raise_exc_info((type, value, traceback11))
        except Exception, e:
            f = open("/home/guangtong/pgt_test/aaa.txt", "a")
            f.write("ffffffff"+str(e)+"\n")
            f.close()
    ...
    def _execute(self, transforms, *args, **kwargs):
        ...
        try:
            ...
            f = open("/home/guangtong/pgt_test/aaa.txt", "a")
            f.write("self._finish is %s %s\n" % (str(self._finished), str(self._auto_finish)))
            f.write("eeee0000 self id is %d\n" % id(self))
            f.close()
            ...
            if result is not None:
                raise TypeError("Expected None, got %r" % result)
            f = open("/home/guangtong/pgt_test/aaa.txt", "a")
            f.write("eeeeee1111 self._finish is %s %s\n" % (str(self._finished), str(self._auto_finish)))
            f.close()
            if self._auto_finish and not self._finished:
                f = open("/home/guangtong/pgt_test/aaa.txt", "a")
                f.write("eeeeeeeeeeee\n")
                f.close()
                self.finish()
        except Exception as e:
            f = open("/home/guangtong/pgt_test/aaa.txt", "a")
            f.write("eeeeee222222%s\n"% str(e))
            f.close()
            try:
...
def asynchronous(method):
    ...
    def wrapper(self, *args, **kwargs):
        ...
        with stack_context.ExceptionStackContext(
            ...
            f = open("/home/guangtong/pgt_test/aaa.txt", "a")
            f.write("hhhhhhh is %s %s\n" % (str(self._finished), str(self._auto_finish)))
            f.close()
            result = method(self, *args, **kwargs)
            f = open("/home/guangtong/pgt_test/aaa.txt", "a")
            f.write("iiiiiiii is %s %s\n" % (str(self._finished), str(self._auto_finish)))
            f.close()
            if is_future(result):
...
class _RequestDispatcher(httputil.HTTPMessageDelegate):
    ...
    def execute(self):
        ...
        f = self.handler._execute(transforms, *self.path_args,
                                  **self.path_kwargs)
        f = open("/home/guangtong/pgt_test/aaa.txt", "a")
        f.write("yyyyyyyy %s %s\n" % (str(self.handler._finished), str(self.handler._auto_finish)))
        f.close()
